...
import WhatsappImg from '../assets/image/WhatsApp.jpeg';

function Contact() {
  const contactDetails = [
    { label: "PHONE", val: "01880-960014" },
    { label: "WHATSAPP", val: "01880-960014"  },
    { label: "TELEGRAM", val: "01880-960014" },
    { label: "EMAIL", val: "mdsibgatullah94@gmail.com", href: "mailto:mdshibgatullah94@gmail.com" }
  ];
          ...
          <div className="row g-0">
            ...
            <div className="col-md-5 contact-qr">
              <div className="qr-frame">
                <img src={WhatsappImg} alt="WhatsApp QR code" />
              </div>
